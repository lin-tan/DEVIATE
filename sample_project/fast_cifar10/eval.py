...
parser.add_argument('network', choices=('RN32', 'WRN32-10'), help="the network")
parser.add_argument('attack', choices=('FGSM', 'PGD'), help="the adversarial attack")
...
if network == 'RN32':
    from model_RN32 import Model
else:
    from model import Model

if attack == 'FGSM':
    config_filename = 'config_fgsm.json'
else:
    config_filename = 'config_pgd.json'
